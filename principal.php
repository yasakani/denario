  ...
  <tr>
    <td style="background-image:url(imagenes/bg-login.png); background-position:top center; background-repeat:repeat-x; background-attachment:fixed;"><table width="780" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="600" align="right"> <img src="imagenes/user-miniicon.png" width="18" height="18" /> Bienvenido! <b><?php echo $loginarray->nombre_operador; ?></b>, <?php echo $loginarray->cargo; ?> (<a href="index.php" class="link">Cerrar Sesión</a>)<br/></td>
      </tr>
      </table>
        ...
        <td style="background-image:url(imagenes/bg-content.png); background-repeat:repeat-y;"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td width="182" align="center" class="font-details"> Tipo 00 =
                <?php
          ...
          <table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td align="center"> Tipo 00 = <?php echo $numero_calc_00_dia ?> Vendidas ($
                <?php
			 	...
			 	?>.00 m.n.)<br />
                Tipo 0 = <?php echo $numero_calc_0_dia ?> Vendidas ($
                <?php
			 	...
			 	?>.00 m.n.)<br />
                Tipo 2 = <?php echo $numero_calc_2_dia ?> Vendidas ($
                <?php
			 	...
			 	?>.00 m.n.) </td>
              <td width="375" align="center"> Tipo 00 = <?php echo $numero_calc_00_total ?> Vendidas ($
                <?php
			 	...
			 	?>.00 m.n.)<br />
                Tipo 0 = <?php echo $numero_calc_0_total ?> Vendidas ($
                <?php
				...
				?>.00 m.n.)<br />
                Tipo 2 = <?php echo $numero_calc_2_total ?> Vendidas ($
                <?php
          ...
          <table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td align="center"> Cortesía Tipo 00 = <?php echo $numero_cort_00; ?> unidades<br />
                Cortesía Tipo 0 = <?php echo $numero_cort_0; ?> unidades <br />
                Cortesía Tipo 2 = <?php echo $numero_cort_2; ?> unidades</td>
              <td width="375" align="center"> Cortesía Tipo 00 = <?php echo $numero_cort_00_total; ?> unidades <br />
